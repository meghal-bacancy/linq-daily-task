namespace day1
{
    public class Vehicle
    {
        ...
        public static List<Vehicle> GetVehicles()
        {
            ...
            {
                new Vehicle(1, "Model S", "Tesla", 79999.99, new List<string>{"Electric"}),
                new Vehicle(2, "Civic", "Honda", 25000, new List<string>{"Petrol", "Hybrid"}),
                new Vehicle(3, "Corolla", "Toyota", 22000, new List<string>{"Petrol"}),
                new Vehicle(4, "Mustang", "Ford", 55000, new List<string>{"Petrol"}),
                new Vehicle(5, "Model X", "Tesla", 89999.99, new List<string>{"Electric"}),
                new Vehicle(6, "Camry", "Toyota", 27000, new List<string>{"Hybrid", "Petrol"}),
                new Vehicle(7, "F-150", "Ford", 40000, new List<string>{"Petrol", "Diesel"}),
                new Vehicle(8, "Accord", "Honda", 28000, new List<string>{"Hybrid", "Petrol"}),
                ...
                new Vehicle(14, "Ranger", "Ford", 37000, new List<string>{"Diesel"}),
                new Vehicle(15, "Altima", "Nissan", 24000, new List<string>{"Petrol"}),
                new Vehicle(16, "Sentra", "Nissan", 21000, new List<string>{"Petrol"}),
                new Vehicle(17, "CX-5", "Mazda", 29000, new List<string>{"Petrol", "Diesel"}),
